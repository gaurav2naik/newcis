...
<%top_city_resp webData = new top_city_resp();
			String webWorkLoad = webData.getCityWorkloadForWeb(7);
...
<%top_city_resp appData = new top_city_resp();
			String appWorkLoad = webData.getCityWorkloadForApplication(7);
...
<body>
	<%
		...
		double apdexScore = getApdexScore.getDayApdexScore_web(7);
		//double apdexScore = 0.96;
		double apdexScore_mobile = getApdexScore.getDayApdexScore_mobile(7);
	%>
	<%
		if (apdexScore <= 0.7) {
	%>
